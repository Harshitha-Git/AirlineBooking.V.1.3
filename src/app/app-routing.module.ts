...
const routes: Routes = [
  ...
  {path: 'addFlight', component: AddBusComponent},
  {path: 'updateFlight', component: UpdateBusComponent},
  {path: 'deleteFlight', component: DeleteBusComponent},
  ...
  {path: 'showAllFlights', component: ShowAllBusesComponent},
